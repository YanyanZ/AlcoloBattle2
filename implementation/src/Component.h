#ifndef TUTORIAL_8_IMPL_LIB_COMPONENT_H
#define TUTORIAL_8_IMPL_LIB_COMPONENT_H
...
namespace templates
{
	namespace impl_lib
	{
		...
		{
			MLV_DEFINE_TYPE_1(templates::impl_lib::Component,"f53669cb-7c79-4433-8483-d2a013b47769",mlv::simulation::AbstractComponent);
		public:
